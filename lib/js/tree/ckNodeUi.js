 ...
 */
TYPO3.Components.PageTree.CkNodeUi = Ext.extend(Ext.tree.TreeNodeUI, {
	/**
...
//        this.iconNode = cs[2];
    ...
    onTipChange : function(node, tip, title) {
		TYPO3.Components.PageTree.CkNodeUi.superclass.onTipChange.apply(this, arguments);
	...
	onOver: function() {
		if (!this.node.ownerTree.dontSetOverClass) {
			TYPO3.Components.PageTree.CkNodeUi.superclass.onOver.apply(this, arguments);
		}
	}
});

// XTYPE Registration
Ext.reg('TYPO3.Components.PageTree.CkNodeUi', TYPO3.Components.PageTree.CkNodeUi);
